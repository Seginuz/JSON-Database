...
class Rating implements Comparable<Rating> {
    ...
    public int compareTo(Rating rating) {
        int thisTotalRating = this.getUpVotes() - this.getDownVotes();
        int otherTotalRating = rating.getUpVotes() - rating.getDownVotes();

        return Integer.compare(thisTotalRating, otherTotalRating);
    }
}
